$(function () {
    ...
    var datalist = $('#data').DataTable({
        ...
        "ajax": {
            "url": base_url + "/pelaksanaan/listdata",
            "type": "POST"
        }
    });
    ...
    {
        $.ajax({
            url: base_url + "/pelaksanaan/getData/"+id,
            type: "GET",
            dataType: "json",
            beforeSend: function () {
                swal.fire({
    ...
    function hapusdata($id)
    {
        swal.fire({
            ...
            preConfirm: function () {
                $.ajax({
                    url: base_url + "/pelaksanaan/hapus",
                    type: "POST",
                    data: { id: $id}
                })
                        .done(function (data) {
    ...
    $("#formadddata").formValidation({
        ...
        $.ajax({
            url: base_url + "/pelaksanaan/tambah",
            type: "POST",
            data: formData,
