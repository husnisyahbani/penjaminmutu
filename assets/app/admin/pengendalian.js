$(function () {
    ...
    var datalist = $('#data').DataTable({
        ...
        "ajax": {
            "url": base_url + "/pengendalian/listdata",
            "type": "POST"
        }
    });
    ...
    {
        $.ajax({
            url: base_url + "/pengendalian/getData/"+id,
            type: "GET",
            dataType: "json",
            beforeSend: function () {
                swal.fire({
    ...
    function hapusdata($id)
    {
        swal.fire({
            ...
            preConfirm: function () {
                $.ajax({
                    url: base_url + "/pengendalian/hapus",
                    type: "POST",
                    data: { id: $id}
                })
                        .done(function (data) {
    ...
    $("#formadddata").formValidation({
        ...
        $.ajax({
            url: base_url + "/pengendalian/tambah",
            type: "POST",
            data: formData,
...
$("#formeditdata").formValidation({
        ...
        $.ajax({
            url: base_url + "/pengendalian/edit",
            type: "POST",
            data: formData,
            processData: false,        // ✅ wajib
            contentType: false,        // ✅ wajib
