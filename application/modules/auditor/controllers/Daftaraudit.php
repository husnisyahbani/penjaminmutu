...
class Daftaraudit extends MY_Controller {
    ...
    public function __construct() {
        parent::__construct();
        $this->module = 'auditor';
        $this->load->js(base_url("assets/app/auditor/daftaraudit.js?v=1.58"));
    ...
    public function listpertanyaan($id=null) {
        ...
        foreach ($list as $field) {
           ...
           if(isset($field->jwb_jawaban)){
                ...
                $row[] = ' <button type="button" class="btn btn-danger btn-xs waves-effect waves-classic"><i class="icon md-edit" aria-hidden="true"></i>Auditee Tidak Menjawab</button>';
           }
