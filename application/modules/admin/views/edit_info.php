            ...
            <div class="col-lg-12">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" id="formeditdata" autocomplete="off" action="<?php if(isset($result[0]['data_id'])) echo base_url() . 'admin/info/editdata?id='.$result[0]['data_id'];?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="data_kategori" value="INFO" readonly/>
                                </div>
                            </div>
