            ...
            foreach ($features as $row) {
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-item">
                        ...
                        <div class="feature-text" onclick="window.open('<?php echo $row['link']; ?>', '_blank');">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 mt_30">
                <div class="team-photo">
                                <img src="<?php echo base_url(); ?>public/uploads/<?php echo $page_home_lang_independent['home_welcome_video_bg']; ?>" alt="Team Photo">
                            </div>
        ...
        <div class="row">
            <div class="col-lg-12 mt_30">
                <div class="about-tab" style="background-image: url(<?php echo base_url(); ?>public/uploads/824cc553ffa44f60bc3ae3d27e0eaa83.jpeg);background-size:45%;">
                    <div class="video-section">
                        <a class="video-button" href="#" data-toggle="modal" data-target="#myModal"><span></span></a>
                    </div>
                </div>
